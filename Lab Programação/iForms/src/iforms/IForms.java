...
import iforms.View.Dashboard;
import iforms.View.FrameManager;
import iforms.View.Main;
import iforms.View.Teste;
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                JDesktopPane mainPane = main.desktopPane;                
                
                //CARREGA A TELA INICIAL
                JInternalFrame dashboard = new Dashboard();
                dashboard.pack();
